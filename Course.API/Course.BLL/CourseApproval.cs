...
namespace Course.BLL
{
    public class CourseApproval
    {
        ...
        /// <returns></returns>
        public object GetCourseAboutApprovaled(Query queryCriteria)
        {
            try
            {
        ...
        /// <param name="queryCriteria"></param>
        /// <returns></returns>
        public object GetCourseAboutNotApprovaled(Query queryCriteria)
        {
            try
            {
                using (var db = new pf_course_manageContext())
        ...
        public object Update_CourseApprovalByID(Approval approval, TokenModel token)
        {
            try
            {
                using (var db = new pf_course_manageContext())
        ...
        public object Update_CourseApprovalBatch(ApprovalResult approvalResult, TokenModel token)
        {
            try
            {
                using (var db = new pf_course_manageContext())
