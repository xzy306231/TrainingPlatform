...
public partial class pf_course_manageContext : DbContext
{
    public pf_course_manageContext()
    {
    }

    public pf_course_manageContext(DbContextOptions<pf_course_manageContext> options)
        : base(options)
    {
    }
    ...
    {
        var builder = new ConfigurationBuilder().SetBasePath(Path.GetDirectoryName(new pf_course_manageContext().GetType().Assembly.Location)).AddJsonFile("dalsettings.json");
    ...
    public virtual DbSet<t_plan_course_task_ref> t_plan_course_task_ref { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //    entity.Property(e => e.user_id).HasColumnType("varchar(20)");
        //});
        ...
        //    entity.Property(e => e.delete_flag).HasColumnType("tinyint(2)").HasDefaultValueSql("'0'");
        ...
        //    entity.Property(e => e.delete_desc).HasColumnType("varchar(20)");
        ...
        //    entity.Property(e => e.node_type_desc).HasColumnType("varchar(20)");
        ...
        //    entity.Property(e => e.publish_flag).HasColumnType("tinyint(2)").HasDefaultValueSql("'0'");

        //    entity.Property(e => e.quit_flag).HasColumnType("tinyint(2)");
        ...
        //    entity.Property(e => e.stu_count).HasColumnType("int(11)").HasDefaultValueSql("'0'");
        ...
        //    entity.Property(e => e.tag_desc)
        //        .HasColumnName("tag_desc")
        //        .HasColumnType("longtext");

        //    entity.Property(e => e.tag_sort)
        //        .HasColumnName("tag_sort")
        //        .HasColumnType("int(11)");
        ...
        //modelBuilder.Entity<t_plan_course_task_ref>(entity =>
        //{
        //    entity.Property(e => e.id).HasColumnType("bigint(20)");
        ...
        //    entity.Property(e => e.endorsement_type).HasColumnType("varchar(5)");
        ...
        //    entity.Property(e => e.qualification_type).HasColumnType("varchar(5)");
        ...
        //    entity.Property(e => e.train_type).HasColumnType("varchar(5)");
        ...
        //    entity.Property(e => e.uesr_number).HasColumnType("varchar(20)");
        ...
        modelBuilder.Entity<t_learning_record>(entity =>
        {
            ...
            entity.Property(e => e.user_id).HasColumnType("varchar(50)");
        });
