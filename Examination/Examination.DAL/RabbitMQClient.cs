...
{
    //Scaffold-DbContext "server=192.168.1.143;userid=root;pwd=root;port=3306;database=pf_examination;sslmode=none;" Pomelo.EntityFrameworkCore.MySql -OutputDir Models -UseDatabaseNames -Force
    ...
    public RabbitMQClient()
    {
        ...
        strRoutingKey4 = config.GetSection("RoutingKey4").Value;
