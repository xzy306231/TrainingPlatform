...
public partial class pf_exam_paper_questionsContext : DbContext
{
    ...
    {
        var builder = new ConfigurationBuilder().SetBasePath(Path.GetDirectoryName(new pf_exam_paper_questionsContext().GetType().Assembly.Location)).AddJsonFile("dalsettings.json");
