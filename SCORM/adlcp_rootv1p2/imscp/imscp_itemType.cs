	...
	public class itemType : Altova.Node
	{
		...
		public override void AdjustPrefix()
		{
			...
			for (int i = 0; i < nCount; i++)
			{
				...
				InternalAdjustPrefix(DOMNode, false);
				new adlcp_metadataType(DOMNode).AdjustPrefix();
			}
		}
		...
		public void Addmetadata(adlcp_metadataType newValue)
		{
			AppendDomElement("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "metadata", newValue);
		}

		public void InsertmetadataAt(adlcp_metadataType newValue, int index)
		{
			InsertDomElementAt("http://www.imsproject.org/xsd/imscp_rootv1p1p2", "metadata", index, newValue);
		}

		public void ReplacemetadataAt(adlcp_metadataType newValue, int index)
		{
        ...
        public class metadataEnumerator: IEnumerator 
        {
			...
			public adlcp_metadataType  Current 
			{
				get 
				{
