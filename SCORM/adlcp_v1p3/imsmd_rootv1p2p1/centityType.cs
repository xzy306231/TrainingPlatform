...
{
	public class centityType : Altova.Node
	{
		#region Forward constructors
		public centityType() : base() { SetCollectionParents(); }
		public centityType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public centityType(XmlNode node) : base(node) { SetCollectionParents(); }
		public centityType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class vcardEnumerator: IEnumerator 
        {
			int nIndex;
			centityType parent;
			public vcardEnumerator(centityType par) 
			{
				parent = par;
				nIndex = -1;
			}
