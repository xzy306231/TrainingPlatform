//
// otherplatformrequirementsType.cs.cs
//
...
{
	public class otherplatformrequirementsType : Altova.Node
	{
		#region Forward constructors
		public otherplatformrequirementsType() : base() { SetCollectionParents(); }
		public otherplatformrequirementsType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public otherplatformrequirementsType(XmlNode node) : base(node) { SetCollectionParents(); }
		public otherplatformrequirementsType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            otherplatformrequirementsType parent;
            public otherplatformrequirementsType Parent
			{
				set
				{
					parent = value;
