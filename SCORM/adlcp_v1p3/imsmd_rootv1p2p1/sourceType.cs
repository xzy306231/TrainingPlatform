...
{
	public class sourceType : Altova.Node
	{
		#region Forward constructors
		public sourceType() : base() { SetCollectionParents(); }
		public sourceType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public sourceType(XmlNode node) : base(node) { SetCollectionParents(); }
		public sourceType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class langstringEnumerator: IEnumerator 
        {
			int nIndex;
			sourceType parent;
			public langstringEnumerator(sourceType par) 
			{
				parent = par;
				nIndex = -1;
			}
