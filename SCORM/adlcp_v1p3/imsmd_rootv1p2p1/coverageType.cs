...
{
	public class coverageType : Altova.Node
	{
		#region Forward constructors
		public coverageType() : base() { SetCollectionParents(); }
		public coverageType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public coverageType(XmlNode node) : base(node) { SetCollectionParents(); }
		public coverageType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class langstringEnumerator: IEnumerator 
        {
			int nIndex;
			coverageType parent;
			public langstringEnumerator(coverageType par) 
			{
				parent = par;
				nIndex = -1;
			}
