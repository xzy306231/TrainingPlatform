...
{
	public class nameType : Altova.Node
	{
		...
		public nameType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			nameType parent;
			public sourceEnumerator(nameType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			nameType parent;
			public valueEnumerator(nameType par) 
			{
				parent = par;
				nIndex = -1;
			}
