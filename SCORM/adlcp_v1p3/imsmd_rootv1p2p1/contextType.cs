...
{
	public class contextType : Altova.Node
	{
		#region Forward constructors
		public contextType() : base() { SetCollectionParents(); }
		public contextType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public contextType(XmlNode node) : base(node) { SetCollectionParents(); }
		public contextType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			contextType parent;
			public sourceEnumerator(contextType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			contextType parent;
			public valueEnumerator(contextType par) 
			{
				parent = par;
				nIndex = -1;
			}
