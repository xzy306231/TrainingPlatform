...
{
	public class semanticdensityType : Altova.Node
	{
		#region Forward constructors
		public semanticdensityType() : base() { SetCollectionParents(); }
		public semanticdensityType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public semanticdensityType(XmlNode node) : base(node) { SetCollectionParents(); }
		public semanticdensityType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            semanticdensityType parent;
            public semanticdensityType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			semanticdensityType parent;
			public sourceEnumerator(semanticdensityType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			semanticdensityType parent;
			public valueEnumerator(semanticdensityType par) 
			{
				parent = par;
				nIndex = -1;
			}
