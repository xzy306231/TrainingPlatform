...
{
	public class statusType : Altova.Node
	{
		#region Forward constructors
		public statusType() : base() { SetCollectionParents(); }
		public statusType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public statusType(XmlNode node) : base(node) { SetCollectionParents(); }
		public statusType(Altova.Node node) : base(node) { SetCollectionParents(); }
