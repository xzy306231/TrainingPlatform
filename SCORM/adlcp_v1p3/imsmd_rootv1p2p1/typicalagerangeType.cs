...
{
	public class typicalagerangeType : Altova.Node
	{
		#region Forward constructors
		public typicalagerangeType() : base() { SetCollectionParents(); }
		public typicalagerangeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public typicalagerangeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public typicalagerangeType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            typicalagerangeType parent;
            public typicalagerangeType Parent
			{
				set
				{
					parent = value;
        ...
        public class langstringEnumerator: IEnumerator 
        {
			int nIndex;
			typicalagerangeType parent;
			public langstringEnumerator(typicalagerangeType par) 
			{
				parent = par;
				nIndex = -1;
			}
