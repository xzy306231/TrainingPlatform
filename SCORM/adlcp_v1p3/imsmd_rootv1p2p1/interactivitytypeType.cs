...
{
	public class interactivitytypeType : Altova.Node
	{
		#region Forward constructors
		public interactivitytypeType() : base() { SetCollectionParents(); }
		public interactivitytypeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public interactivitytypeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public interactivitytypeType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            interactivitytypeType parent;
            public interactivitytypeType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			interactivitytypeType parent;
			public sourceEnumerator(interactivitytypeType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			interactivitytypeType parent;
			public valueEnumerator(interactivitytypeType par) 
			{
				parent = par;
				nIndex = -1;
			}
