...
{
	public class entryType : Altova.Node
	{
		#region Forward constructors
		public entryType() : base() { SetCollectionParents(); }
		public entryType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public entryType(XmlNode node) : base(node) { SetCollectionParents(); }
		public entryType(Altova.Node node) : base(node) { SetCollectionParents(); }
