...
{
	public class roleType : Altova.Node
	{
		#region Forward constructors
		public roleType() : base() { SetCollectionParents(); }
		public roleType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public roleType(XmlNode node) : base(node) { SetCollectionParents(); }
		public roleType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			roleType parent;
			public sourceEnumerator(roleType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			roleType parent;
			public valueEnumerator(roleType par) 
			{
				parent = par;
				nIndex = -1;
			}
