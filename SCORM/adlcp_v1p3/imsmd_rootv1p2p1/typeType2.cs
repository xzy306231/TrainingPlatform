...
{
	public class typeType2 : Altova.Node
	{
		#region Forward constructors
		public typeType2() : base() { SetCollectionParents(); }
		public typeType2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public typeType2(XmlNode node) : base(node) { SetCollectionParents(); }
		public typeType2(Altova.Node node) : base(node) { SetCollectionParents(); }
