...
{
	public class structureType : Altova.Node
	{
		#region Forward constructors
		public structureType() : base() { SetCollectionParents(); }
		public structureType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public structureType(XmlNode node) : base(node) { SetCollectionParents(); }
		public structureType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			structureType parent;
			public sourceEnumerator(structureType par) 
			{
				parent = par;
				nIndex = -1;
			}
