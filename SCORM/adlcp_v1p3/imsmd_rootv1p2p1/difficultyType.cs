...
{
	public class difficultyType : Altova.Node
	{
		#region Forward constructors
		public difficultyType() : base() { SetCollectionParents(); }
		public difficultyType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public difficultyType(XmlNode node) : base(node) { SetCollectionParents(); }
		public difficultyType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            difficultyType parent;
            public difficultyType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			difficultyType parent;
			public sourceEnumerator(difficultyType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			difficultyType parent;
			public valueEnumerator(difficultyType par) 
			{
				parent = par;
				nIndex = -1;
			}
