...
{
	public class kindType : Altova.Node
	{
		#region Forward constructors
		public kindType() : base() { SetCollectionParents(); }
		public kindType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public kindType(XmlNode node) : base(node) { SetCollectionParents(); }
		public kindType(Altova.Node node) : base(node) { SetCollectionParents(); }
