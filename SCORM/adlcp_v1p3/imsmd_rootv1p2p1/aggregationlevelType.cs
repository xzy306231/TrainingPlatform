...
{
	public class aggregationlevelType : Altova.Node
	{
		#region Forward constructors
		public aggregationlevelType() : base() { SetCollectionParents(); }
		public aggregationlevelType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public aggregationlevelType(XmlNode node) : base(node) { SetCollectionParents(); }
		public aggregationlevelType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            aggregationlevelType parent;
            public aggregationlevelType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			aggregationlevelType parent;
			public sourceEnumerator(aggregationlevelType par) 
			{
				parent = par;
				nIndex = -1;
			}
