...
{
	public class installationremarksType : Altova.Node
	{
		#region Forward constructors
		public installationremarksType() : base() { SetCollectionParents(); }
		public installationremarksType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public installationremarksType(XmlNode node) : base(node) { SetCollectionParents(); }
		public installationremarksType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            installationremarksType parent;
            public installationremarksType Parent
			{
				set
				{
					parent = value;
        ...
        public class langstringEnumerator: IEnumerator 
        {
			int nIndex;
			installationremarksType parent;
			public langstringEnumerator(installationremarksType par) 
			{
				parent = par;
				nIndex = -1;
			}
