//
// copyrightandotherrestrictionsType.cs.cs
//
...
{
	public class copyrightandotherrestrictionsType : Altova.Node
	{
		#region Forward constructors
		public copyrightandotherrestrictionsType() : base() { SetCollectionParents(); }
		public copyrightandotherrestrictionsType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public copyrightandotherrestrictionsType(XmlNode node) : base(node) { SetCollectionParents(); }
		public copyrightandotherrestrictionsType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            copyrightandotherrestrictionsType parent;
            public copyrightandotherrestrictionsType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			copyrightandotherrestrictionsType parent;
			public sourceEnumerator(copyrightandotherrestrictionsType par) 
			{
				parent = par;
				nIndex = -1;
			}
