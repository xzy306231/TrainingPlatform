...
{
	public class interactivitylevelType : Altova.Node
	{
		#region Forward constructors
		public interactivitylevelType() : base() { SetCollectionParents(); }
		public interactivitylevelType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public interactivitylevelType(XmlNode node) : base(node) { SetCollectionParents(); }
		public interactivitylevelType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            interactivitylevelType parent;
            public interactivitylevelType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			interactivitylevelType parent;
			public sourceEnumerator(interactivitylevelType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			interactivitylevelType parent;
			public valueEnumerator(interactivitylevelType par) 
			{
				parent = par;
				nIndex = -1;
			}
