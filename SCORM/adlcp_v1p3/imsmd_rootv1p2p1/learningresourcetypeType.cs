//
// learningresourcetypeType.cs.cs
//
...
{
	public class learningresourcetypeType : Altova.Node
	{
		#region Forward constructors
		public learningresourcetypeType() : base() { SetCollectionParents(); }
		public learningresourcetypeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public learningresourcetypeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public learningresourcetypeType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            learningresourcetypeType parent;
            public learningresourcetypeType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			learningresourcetypeType parent;
			public sourceEnumerator(learningresourcetypeType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			learningresourcetypeType parent;
			public valueEnumerator(learningresourcetypeType par) 
			{
				parent = par;
				nIndex = -1;
			}
