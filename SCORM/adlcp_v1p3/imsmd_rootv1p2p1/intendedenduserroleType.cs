...
{
	public class intendedenduserroleType : Altova.Node
	{
		#region Forward constructors
		public intendedenduserroleType() : base() { SetCollectionParents(); }
		public intendedenduserroleType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public intendedenduserroleType(XmlNode node) : base(node) { SetCollectionParents(); }
		public intendedenduserroleType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            intendedenduserroleType parent;
            public intendedenduserroleType Parent
			{
				set
				{
					parent = value;
        ...
        public class sourceEnumerator: IEnumerator 
        {
			int nIndex;
			intendedenduserroleType parent;
			public sourceEnumerator(intendedenduserroleType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class valueEnumerator: IEnumerator 
        {
			int nIndex;
			intendedenduserroleType parent;
			public valueEnumerator(intendedenduserroleType par) 
			{
				parent = par;
				nIndex = -1;
			}
