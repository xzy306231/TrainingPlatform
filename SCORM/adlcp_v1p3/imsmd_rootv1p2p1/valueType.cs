...
{
	public class valueType : Altova.Node
	{
		#region Forward constructors
		public valueType() : base() { SetCollectionParents(); }
		public valueType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public valueType(XmlNode node) : base(node) { SetCollectionParents(); }
		public valueType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class langstringEnumerator: IEnumerator 
        {
			int nIndex;
			valueType parent;
			public langstringEnumerator(valueType par) 
			{
				parent = par;
				nIndex = -1;
			}
