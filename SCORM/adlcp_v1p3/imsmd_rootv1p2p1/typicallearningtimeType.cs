...
{
	public class typicallearningtimeType : Altova.Node
	{
		#region Forward constructors
		public typicallearningtimeType() : base() { SetCollectionParents(); }
		public typicallearningtimeType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public typicallearningtimeType(XmlNode node) : base(node) { SetCollectionParents(); }
		public typicallearningtimeType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            typicallearningtimeType parent;
            public typicallearningtimeType Parent
			{
				set
				{
					parent = value;
        ...
        public class datetimeEnumerator: IEnumerator 
        {
			int nIndex;
			typicallearningtimeType parent;
			public datetimeEnumerator(typicallearningtimeType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class descriptionEnumerator: IEnumerator 
        {
			int nIndex;
			typicallearningtimeType parent;
			public descriptionEnumerator(typicallearningtimeType par) 
			{
				parent = par;
				nIndex = -1;
			}
