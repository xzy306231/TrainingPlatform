...
{
	public class descriptionType : Altova.Node
	{
		#region Forward constructors
		public descriptionType() : base() { SetCollectionParents(); }
		public descriptionType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public descriptionType(XmlNode node) : base(node) { SetCollectionParents(); }
		public descriptionType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class langstringEnumerator: IEnumerator 
        {
			int nIndex;
			descriptionType parent;
			public langstringEnumerator(descriptionType par) 
			{
				parent = par;
				nIndex = -1;
			}
