...
{
	public class ruleConditionType2 : Altova.Node
	{
		#region Forward constructors
		public ruleConditionType2() : base() { SetCollectionParents(); }
		public ruleConditionType2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ruleConditionType2(XmlNode node) : base(node) { SetCollectionParents(); }
		public ruleConditionType2(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            ruleConditionType2 parent;
            public ruleConditionType2 Parent
			{
				set
				{
					parent = value;
        ...
        public class referencedObjectiveEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType2 parent;
			public referencedObjectiveEnumerator(ruleConditionType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class measureThresholdEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType2 parent;
			public measureThresholdEnumerator(ruleConditionType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class operator2Enumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType2 parent;
			public operator2Enumerator(ruleConditionType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class conditionEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType2 parent;
			public conditionEnumerator(ruleConditionType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
