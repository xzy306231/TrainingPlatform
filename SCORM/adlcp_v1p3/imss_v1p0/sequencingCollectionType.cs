...
{
	public class sequencingCollectionType : adlcp_v1p3.Altova.Node
	{
		...
		public sequencingCollectionType(adlcp_v1p3.Altova.Node node) : base(node) { SetCollectionParents(); }
