...
{
	public class objectiveType : Altova.Node
	{
		#region Forward constructors
		public objectiveType() : base() { SetCollectionParents(); }
		public objectiveType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public objectiveType(XmlNode node) : base(node) { SetCollectionParents(); }
		public objectiveType(Altova.Node node) : base(node) { SetCollectionParents(); }
		...
		public override void AdjustPrefix()
		{
			...
			for (int i = 0; i < nCount; i++)
			{
				...
				InternalAdjustPrefix(DOMNode, true);
				new mapInfoType2(DOMNode).AdjustPrefix();
			}
		}
        ...
        {
            objectiveType parent;
            public objectiveType Parent
			{
				set
				{
					parent = value;
        ...
        public class satisfiedByMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveType parent;
			public satisfiedByMeasureEnumerator(objectiveType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class objectiveIDEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveType parent;
			public objectiveIDEnumerator(objectiveType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class minNormalizedMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveType parent;
			public minNormalizedMeasureEnumerator(objectiveType par) 
			{
				parent = par;
				nIndex = -1;
			}
		...
		public mapInfoType2 GetmapInfoAt(int index)
		{
			return new mapInfoType2(GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imsss", "mapInfo", index));
		}

		public mapInfoType2 GetmapInfo()
		{
			return GetmapInfoAt(0);
		}

		public mapInfoType2 mapInfo
		{
			get
			{
				return GetmapInfoAt(0);
		...
		public void AddmapInfo(mapInfoType2 newValue)
		{
			AppendDomElement("http://www.imsglobal.org/xsd/imsss", "mapInfo", newValue);
		}

		public void InsertmapInfoAt(mapInfoType2 newValue, int index)
		{
			InsertDomElementAt("http://www.imsglobal.org/xsd/imsss", "mapInfo", index, newValue);
		}

		public void ReplacemapInfoAt(mapInfoType2 newValue, int index)
		{
        ...
        public class mapInfoEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveType parent;
			public mapInfoEnumerator(objectiveType par) 
			{
				parent = par;
				nIndex = -1;
			}
