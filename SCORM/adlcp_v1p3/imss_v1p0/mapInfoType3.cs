...
{
	public class mapInfoType3 : Altova.Node
	{
		#region Forward constructors
		public mapInfoType3() : base() { SetCollectionParents(); }
		public mapInfoType3(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public mapInfoType3(XmlNode node) : base(node) { SetCollectionParents(); }
		public mapInfoType3(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class targetObjectiveIDEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType3 parent;
			public targetObjectiveIDEnumerator(mapInfoType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class readSatisfiedStatusEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType3 parent;
			public readSatisfiedStatusEnumerator(mapInfoType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class readNormalizedMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType3 parent;
			public readNormalizedMeasureEnumerator(mapInfoType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class writeSatisfiedStatusEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType3 parent;
			public writeSatisfiedStatusEnumerator(mapInfoType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class writeNormalizedMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType3 parent;
			public writeNormalizedMeasureEnumerator(mapInfoType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
