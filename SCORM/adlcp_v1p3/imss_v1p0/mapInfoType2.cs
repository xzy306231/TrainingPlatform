...
{
	public class mapInfoType2 : Altova.Node
	{
		#region Forward constructors
		public mapInfoType2() : base() { SetCollectionParents(); }
		public mapInfoType2(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public mapInfoType2(XmlNode node) : base(node) { SetCollectionParents(); }
		public mapInfoType2(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        public class targetObjectiveIDEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType2 parent;
			public targetObjectiveIDEnumerator(mapInfoType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class readSatisfiedStatusEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType2 parent;
			public readSatisfiedStatusEnumerator(mapInfoType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class readNormalizedMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType2 parent;
			public readNormalizedMeasureEnumerator(mapInfoType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class writeSatisfiedStatusEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType2 parent;
			public writeSatisfiedStatusEnumerator(mapInfoType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class writeNormalizedMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			mapInfoType2 parent;
			public writeNormalizedMeasureEnumerator(mapInfoType2 par) 
			{
				parent = par;
				nIndex = -1;
			}
