...
{
	public class objectiveMappingType : Altova.Node
	{
		#region Forward constructors
		public objectiveMappingType() : base() { SetCollectionParents(); }
		public objectiveMappingType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public objectiveMappingType(XmlNode node) : base(node) { SetCollectionParents(); }
		public objectiveMappingType(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            objectiveMappingType parent;
            public objectiveMappingType Parent
			{
				set
				{
					parent = value;
        ...
        public class targetObjectiveIDEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveMappingType parent;
			public targetObjectiveIDEnumerator(objectiveMappingType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class readSatisfiedStatusEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveMappingType parent;
			public readSatisfiedStatusEnumerator(objectiveMappingType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class readNormalizedMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveMappingType parent;
			public readNormalizedMeasureEnumerator(objectiveMappingType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class writeSatisfiedStatusEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveMappingType parent;
			public writeSatisfiedStatusEnumerator(objectiveMappingType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class writeNormalizedMeasureEnumerator: IEnumerator 
        {
			int nIndex;
			objectiveMappingType parent;
			public writeNormalizedMeasureEnumerator(objectiveMappingType par) 
			{
				parent = par;
				nIndex = -1;
			}
