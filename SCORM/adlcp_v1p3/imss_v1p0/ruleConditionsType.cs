...
{
	public class ruleConditionsType : adlcp_v1p3.Altova.Node
	{
		#region Forward constructors
		public ruleConditionsType() : base() { SetCollectionParents(); }
		public ruleConditionsType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ruleConditionsType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ruleConditionsType(adlcp_v1p3.Altova.Node node) : base(node) { SetCollectionParents(); }
		...
		public override void AdjustPrefix()
		{
			...
			for (int i = 0; i < nCount; i++)
			{
				...
				new ruleConditionType(DOMNode).AdjustPrefix();
			}
		}
        ...
        {
            ruleConditionsType parent;
            public ruleConditionsType Parent
			{
				set
				{
					parent = value;
        ...
        public class conditionCombinationEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionsType parent;
			public conditionCombinationEnumerator(ruleConditionsType par) 
			{
				parent = par;
				nIndex = -1;
			}
		...
		public ruleConditionType GetruleConditionAt(int index)
		{
			return new ruleConditionType(GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imsss", "ruleCondition", index));
		}

		public ruleConditionType GetruleCondition()
		{
			return GetruleConditionAt(0);
		}

		public ruleConditionType ruleCondition
		{
			get
			{
				return GetruleConditionAt(0);
		...
		public void AddruleCondition(ruleConditionType newValue)
		{
			AppendDomElement("http://www.imsglobal.org/xsd/imsss", "ruleCondition", newValue);
		}

		public void InsertruleConditionAt(ruleConditionType newValue, int index)
		{
			InsertDomElementAt("http://www.imsglobal.org/xsd/imsss", "ruleCondition", index, newValue);
		}

		public void ReplaceruleConditionAt(ruleConditionType newValue, int index)
		{
        ...
        public class ruleConditionEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionsType parent;
			public ruleConditionEnumerator(ruleConditionsType par) 
			{
				parent = par;
				nIndex = -1;
			}
			...
			public ruleConditionType  Current 
			{
				get 
				{
