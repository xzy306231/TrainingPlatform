...
{
	public class ruleConditionType4 : Altova.Node
	{
		#region Forward constructors
		public ruleConditionType4() : base() { SetCollectionParents(); }
		public ruleConditionType4(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ruleConditionType4(XmlNode node) : base(node) { SetCollectionParents(); }
		public ruleConditionType4(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            ruleConditionType4 parent;
            public ruleConditionType4 Parent
			{
				set
				{
					parent = value;
        ...
        public class referencedObjectiveEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType4 parent;
			public referencedObjectiveEnumerator(ruleConditionType4 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class measureThresholdEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType4 parent;
			public measureThresholdEnumerator(ruleConditionType4 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class operator2Enumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType4 parent;
			public operator2Enumerator(ruleConditionType4 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class conditionEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType4 parent;
			public conditionEnumerator(ruleConditionType4 par) 
			{
				parent = par;
				nIndex = -1;
			}
