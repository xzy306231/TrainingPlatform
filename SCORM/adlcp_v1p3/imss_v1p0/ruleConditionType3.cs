...
{
	public class ruleConditionType3 : Altova.Node
	{
		#region Forward constructors
		public ruleConditionType3() : base() { SetCollectionParents(); }
		public ruleConditionType3(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ruleConditionType3(XmlNode node) : base(node) { SetCollectionParents(); }
		public ruleConditionType3(Altova.Node node) : base(node) { SetCollectionParents(); }
        ...
        {
            ruleConditionType3 parent;
            public ruleConditionType3 Parent
			{
				set
				{
					parent = value;
        ...
        public class referencedObjectiveEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType3 parent;
			public referencedObjectiveEnumerator(ruleConditionType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class measureThresholdEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType3 parent;
			public measureThresholdEnumerator(ruleConditionType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class operator2Enumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType3 parent;
			public operator2Enumerator(ruleConditionType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class conditionEnumerator: IEnumerator 
        {
			int nIndex;
			ruleConditionType3 parent;
			public conditionEnumerator(ruleConditionType3 par) 
			{
				parent = par;
				nIndex = -1;
			}
