...
namespace adlcp_v1p3.imscp_v1p1
{
	public class metadataType : Altova.Node
	{
		...
		public override void AdjustPrefix()
		{
			...
			nCount = DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schema");
			for (int i = 0; i < nCount; i++)
			{
				XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schema", i);
				InternalAdjustPrefix(DOMNode, false);
			}

			nCount = DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion");
			for (int i = 0; i < nCount; i++)
			{
				XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion", i);
				InternalAdjustPrefix(DOMNode, false);
			}
		}
		...
		{
			return DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schema");
		}
		...
		{
			return HasDomChild(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schema");
		}

		public schemaType GetschemaAt(int index)
		{
			return new schemaType(GetDomNodeValue(GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schema", index)));
		}
		...
		{
			RemoveDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schema", index);
		}
		...
		{
			InsertDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schema", index, newValue.ToString());
		}
		...
		{
			return DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion");
		}
		...
		{
			return HasDomChild(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion");
		}

		public schemaversionType GetschemaversionAt(int index)
		{
			return new schemaversionType(GetDomNodeValue(GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion", index)));
		}
		...
		{
			RemoveDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion", index);
		}
		...
		{
			AppendDomChild(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion", newValue.ToString());
		}

		public void InsertschemaversionAt(schemaversionType newValue, int index)
		{
			InsertDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion", index, newValue.ToString());
		}

		public void ReplaceschemaversionAt(schemaversionType newValue, int index)
		{
			ReplaceDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "schemaversion", index, newValue.ToString());
		}
