	...
	public class organizationType : Altova.Node
	{
		...
		public override void AdjustPrefix()
		{
			...
			for (int i = 0; i < nCount; i++)
			{
				...
				InternalAdjustPrefix(DOMNode, false);
				new itemTypeExtended(DOMNode).AdjustPrefix();
			}
		...
		public SchemaString GetstructureAt(int index)
		{
			return new SchemaString(GetDomNodeValue(GetDomChildAt(NodeType.Attribute, "", "structure", index)));
		}

		public SchemaString Getstructure()
		{
			return GetstructureAt(0);
		}

		public SchemaString structure
		{
			get
			{
				return GetstructureAt(0);
		...
		public void Addstructure(SchemaString newValue)
		{
			AppendDomChild(NodeType.Attribute, "", "structure", newValue.ToString());
		}

		public void InsertstructureAt(SchemaString newValue, int index)
		{
			InsertDomChildAt(NodeType.Attribute, "", "structure", index, newValue.ToString());
		}

		public void ReplacestructureAt(SchemaString newValue, int index)
		{
