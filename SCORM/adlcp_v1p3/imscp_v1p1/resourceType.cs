...
namespace adlcp_v1p3.imscp_v1p1
{
	public class resourceType : Altova.Node
	{
		...
		public override void AdjustPrefix()
		{
			...
			nCount = DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "file");
			for (int i = 0; i < nCount; i++)
			{
				XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "file", i);
				InternalAdjustPrefix(DOMNode, false);
				new fileType(DOMNode).AdjustPrefix();
			}

			nCount = DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "dependency");
			for (int i = 0; i < nCount; i++)
			{
				XmlNode DOMNode = GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "dependency", i);
				InternalAdjustPrefix(DOMNode, false);
		...
		{
			return DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "file");
		}
		...
		public bool Hasfile()
		{
			return HasDomChild(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "file");
		}

		public fileType GetfileAt(int index)
		{
			return new fileType(GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "file", index));
		}
		...
		{
			RemoveDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "file", index);
		}
		...
		{
			AppendDomElement("http://www.imsglobal.org/xsd/imscp_v1p1", "file", newValue);
		}

		public void InsertfileAt(fileType newValue, int index)
		{
			InsertDomElementAt("http://www.imsglobal.org/xsd/imscp_v1p1", "file", index, newValue);
		}

		public void ReplacefileAt(fileType newValue, int index)
		{
			ReplaceDomElementAt("http://www.imsglobal.org/xsd/imscp_v1p1", "file", index, newValue);
		}
		...
		{
			return DomChildCount(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "dependency");
		}
		...
		{
			return HasDomChild(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "dependency");
		}

		public dependencyType GetdependencyAt(int index)
		{
			return new dependencyType(GetDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "dependency", index));
		}
		...
		{
			RemoveDomChildAt(NodeType.Element, "http://www.imsglobal.org/xsd/imscp_v1p1", "dependency", index);
		}
		...
		{
			AppendDomElement("http://www.imsglobal.org/xsd/imscp_v1p1", "dependency", newValue);
		}

		public void InsertdependencyAt(dependencyType newValue, int index)
		{
			InsertDomElementAt("http://www.imsglobal.org/xsd/imscp_v1p1", "dependency", index, newValue);
		}

		public void ReplacedependencyAt(dependencyType newValue, int index)
		{
			ReplaceDomElementAt("http://www.imsglobal.org/xsd/imscp_v1p1", "dependency", index, newValue);
		}
