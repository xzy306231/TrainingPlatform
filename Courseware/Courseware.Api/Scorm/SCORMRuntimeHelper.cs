...
//namespace Courseware.Api.Scorm
//{
...
//            int coreId = Convert.ToInt32(o.coreId);
//            int cmiDataId;
...
//            }
//            else if (o.dataItem.IndexOf("cmi.interactions", StringComparison.Ordinal) == 0)
//            {
//                //*********************************************************************
//                // handle all the cmi.interactions GetValues
//                //***********************************************************************
//                LMSGetValueInteractions(coreId, o);

//            }
//            else if (o.dataItem.IndexOf("cmi.student_preference", StringComparison.Ordinal) == 0)
//            {
//                //***********************************************************************
...
//            }
//            else if (o.dataItem.IndexOf("cmi.learner_preference", StringComparison.Ordinal) == 0)
//            {
//                //***********************************************************************
...
//            }
//            else if (o.dataItem.IndexOf("cmi.objectives", StringComparison.Ordinal) == 0)
//            {
//                //***********************************************************************
//                // handle all the cmi.objectives GetValues
//                //***********************************************************************
//                DatabaseHelper.LMSGetValueObjectives(coreId, o); // LMSInfo object "o" contains the arguments

//            }
//            else if (o.dataItem.IndexOf("cmi.comments_from_learner", StringComparison.Ordinal) == 0)
//            {
//                //***********************************************************************
//                // handle all the cmi.objectives GetValues
//                //***********************************************************************
//                DatabaseHelper.LMSGetValueCommentsFromLearner(coreId, o); // LMSInfo object "o" contains the arguments

//            }
//            else if (o.dataItem.IndexOf("cmi.comments_from_lms", StringComparison.Ordinal) == 0)
//            {
//                //***********************************************************************
//                // handle all the cmi.objectives GetValues
//                //***********************************************************************
//                DatabaseHelper.LMSGetValueCommentsFromLMS(coreId, o); // LMSInfo object "o" contains the arguments
...
//                        break;
//                    case "cmi.learner_name"://1.3
//                    case "cmi.core.student_name"://1.2 学员姓名
//                        o.returnValue = DatabaseHelper.GetCMICoreById(coreId).student_name;
//                        break;
//                    case "cmi.learner_id"://1.3
//                    case "cmi.core.student_id"://1.2 学员编号
//                        o.returnValue = DatabaseHelper.GetCMICoreById(coreId).student_id;
//                        break;
//                    case "cmi.core.lesson_status"://1.2 状态更改
//                        o.returnValue = DatabaseHelper.GetCMICoreById(coreId).lesson_status;
//                        break;
//                    case "cmi.mode":
//                    case "cmi.core.lesson_mode":
//                        o.returnValue = DatabaseHelper.GetCMICoreById(coreId).lesson_mode;
//                        break;
//                    case "cmi.location"://1.3
//                    case "cmi.core.lesson_location"://1.2 记录最后一次SCO
//                        o.returnValue = DatabaseHelper.GetCMICoreById(coreId).lesson_location;
//                        break;
//                    case "cmi.credit"://1.3
//                    case "cmi.core.credit"://1.2 设为credit表示该SCO会影响课程总成绩
//                        o.returnValue = DatabaseHelper.GetCMICoreById(coreId).credit;
//                        break;
//                    case "cmi.entry"://1.3
//                    case "cmi.core.entry"://1.2 记录学员进入SCO的状态
//                        o.returnValue = DatabaseHelper.GetCMICoreById(coreId).entry;
//                        break;
//                    case "cmi.total_time"://1.3
//                    case "cmi.core.total_time"://1.2 当前SCO学习所花总时间
//                        string totalTime = DatabaseHelper.GetCMICoreById(coreId).total_time;
...
//                        break;
//                    case "cmi.score.raw"://1.3
//                    case "cmi.core.score.raw"://1.2 存放累积的总成绩
//                        decimal? dscore_raw = DatabaseHelper.GetCMICoreById(coreId).score_raw;
//                        o.returnValue = (dscore_raw.HasValue) ? dscore_raw.ToString() : "";
//                        break;
//                    case "cmi.score.min":
//                    case "cmi.core.score.min":
//                        decimal? dscore_min = DatabaseHelper.GetCMICoreById(coreId).score_min;
//                        o.returnValue = (dscore_min.HasValue) ? dscore_min.ToString() : "";
//                        break;
//                    case "cmi.score.max":
//                    case "cmi.core.score.max":
//                        decimal? dscore_max = DatabaseHelper.GetCMICoreById(coreId).score_max;
//                        o.returnValue = (dscore_max.HasValue) ? dscore_max.ToString() : "";
//                        break;
//                    case "cmi.suspend_data"://1.2 SCO用来存放每个学员离开时的暂存资料，下一次进入时再将资料取出
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        o.returnValue = DatabaseHelper.GetCMIDataByID(cmiDataId).suspend_data;
//                        break;
//                    case "cmi.launch_data"://1.2 加载数据
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        o.returnValue = DatabaseHelper.GetCMIDataByID(cmiDataId).launch_data;
//                        break;
//                    case "cmi.comments":
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        o.returnValue = DatabaseHelper.GetCMIDataByID(cmiDataId).cmi_comments;
//                        break;
//                    case "cmi.comments_from_lms":
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        o.returnValue = DatabaseHelper.GetCMIDataByID(cmiDataId).cmi_comments_from_lms;
//                        break;
...
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        decimal? dmastery_score = DatabaseHelper.GetCMIDataByID(cmiDataId).mastery_score;
//                        o.returnValue = (dmastery_score.HasValue) ? dmastery_score.ToString() : "";
//                        break;
//                    case "cmi.student_data.max_time_allowed":
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        o.returnValue = DatabaseHelper.GetCMIDataByID(cmiDataId).max_time_allowed;
//                        break;
//                    case "cmi.student_data.time_limit_action":
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        o.returnValue = DatabaseHelper.GetCMIDataByID(cmiDataId).time_limit_action;
//                        break;
//                    //
//                    // values added for SCORM 2004
//                    //
//                    case "cmi.score.scaled":
//                        decimal? dscore_scaled = DatabaseHelper.GetCMICoreById(coreId).score_scaled;
//                        o.returnValue = (dscore_scaled.HasValue) ? dscore_scaled.ToString() : "";

//                        break;
//                    case "cmi.success_status"://1.3 成功状态
//                        string success_status = DatabaseHelper.GetCMICoreById(coreId).success_status;
...
//                        break;
//                    case "cmi.completion_status"://1.3 完成状态
//                        string completion_status = DatabaseHelper.GetCMICoreById(coreId).completion_status;
...
//                        cmiDataId = DatabaseHelper.GetCmiDataID(o.userId, o.scoIdentifier, o.scormCourseId);
//                        string max_time_allowed = DatabaseHelper.GetCMIDataByID(cmiDataId).max_time_allowed;
...
//        private void LMSGetValueInteractions(int coreId, LMSInfo o)
//        {
//            string version = DatabaseHelper.GetVersion(Convert.ToInt32(o.scormCourseId));
//            if (version == "1.3")
//            {
//                GetValueInteractions2004(coreId, o);
//                return;
//            }
...
//            {
//                o.returnValue = DatabaseHelper.getCountInteractionsByCoreID(coreId).ToString();
//                return;
//            }
...
//                {
//                    int cmi_interactions_id = DatabaseHelper.GetInteractionsID(coreId, n, false);
