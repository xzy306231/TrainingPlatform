...
public interface IHttpClientHelper
{
    ...
    string PostRequestResult(string url, object obj);
}
public class HttpClientHelper : IHttpClientHelper
{
    ...
    public string PostRequestResult(string url, object obj)
    {
        var client = new HttpClient(_handler, false);
        return  client.PostAsJsonAsync(url, obj).Result.Content.ReadAsStringAsync().Result;
    }
