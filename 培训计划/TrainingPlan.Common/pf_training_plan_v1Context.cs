...
{
    //public pf_training_plan_v1Context(IConfiguration configuration)
    //{
    ...
    public virtual DbSet<t_lesson_schedule> t_lesson_schedule { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            var builder = new ConfigurationBuilder().SetBasePath(Path.GetDirectoryName(this.GetType().Assembly.Location)).AddJsonFile("appsettings.json");
            var config = builder.Build();
            string strConn = config.GetConnectionString("MySqlConnection");
    ...
    {
        modelBuilder.Entity<t_classroom>(entity =>
        {
            ...
            entity.Property(e => e.room_capacity)
                .HasColumnType("int(11)")
                .HasDefaultValueSql("'0'");

            entity.Property(e => e.room_function).HasColumnType("longtext");

            entity.Property(e => e.room_name).HasColumnType("varchar(100)");

            entity.Property(e => e.room_number).HasColumnType("varchar(50)");

            entity.Property(e => e.room_status).HasColumnType("varchar(5)");

            entity.Property(e => e.room_type).HasColumnType("varchar(5)");
        ...
        modelBuilder.Entity<t_lesson_schedule>(entity =>
        {
            entity.Property(e => e.id).HasColumnType("bigint(20)");

            entity.Property(e => e.classroom_id).HasColumnType("bigint(20)");

            entity.Property(e => e.content_div).HasColumnType("varchar(5)");

            entity.Property(e => e.content_id).HasColumnType("bigint(20)");

            entity.Property(e => e.content_name).HasColumnType("varchar(200)");
            ...
            entity.Property(e => e.schedule_datetime).HasColumnType("date");
        ...
        modelBuilder.Entity<t_learning_record>(entity =>
        {
            ...
            entity.Property(e => e.learning_totaltime)
            .HasColumnType("decimal(5,2)")
            .HasDefaultValueSql("'0.00'");
